...
const Index = () => {
  ...
  const stats = [
    ...
    { number: "1M+", label: "Invoices Created", icon: FileText },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
        ...
        <div className="text-center mb-20">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 mb-12">
            ...
            <Button 
              onClick={() => navigate('/create-invoice')} 
              variant="outline" 
              className="border-2 border-blue-600 text-blue-600 hover:bg-blue-50 px-10 py-4 text-lg font-semibold transition-all duration-300"
              size="lg"
            >
              View Templates
            </Button>
        ...
        <div className="mb-24">
          ...
          <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-8">
            {features.map((feature, index) => (
              <Card key={index} className="group hover:shadow-2xl transition-all duration-500 border-0 shadow-lg bg-white/80 backdrop-blur-sm hover:-translate-y-2">
                <CardHeader>
      ...
      <DonatingWidget 
        ...
        showGradient={true} 
        title="Love Tallyar?" 
        description="Help us keep building amazing tools" 
      />
    </div>
  );
};
